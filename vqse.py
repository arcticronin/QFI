...
def vqse(num_qubits, density_matrix):
    """
    Variational Quantum State Eigensolver (VQSE) using Estimator.
    ...
    def cost_function(parameters):
        ...
        result = estimator.run(
            circuits=[bound_circuit], observables=[operator]
        ).result()
...
print("Generalized SWAP Test Circuit:")
print(swap_test)
## simulate and get count etc...
